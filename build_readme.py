...
def fetch_music_time():
    return httpx.get(
        "https://gist.githubusercontent.com/Sanksu/dd99736fb1ab67b386cf7432f239458f/raw"
    )
...
def fetch_blog_entries():
    entries = feedparser.parse("https://sanksu.top/atom.xml")["entries"]
    return [
        {
            "title": entry["title"],
...
if __name__ == "__main__":
    ...
    music_time_text = "\n```text\n"+fetch_music_time().text+"\n```\n"

    rewritten = replace_chunk(rewritten, "music_time", music_time_text)
